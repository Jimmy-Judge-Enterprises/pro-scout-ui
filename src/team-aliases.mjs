...
//
// Keys are canonical nflverse team_id values -- the same values already used
// in team_manifest.json / player_manifest.json's team_id field. Extend this
// list, do not invent a second source of truth for team identity.
const TEAM_ALIASES = {
  ARI: ["ari", "az", "arz", "arizona", "cardinals", "cards"],
